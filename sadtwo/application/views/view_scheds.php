...
echo "<th><input type='text' class='form-control' placeholder='Date' disabled></th>";
echo "<th><input type='text' class='form-control' placeholder='Time' disabled></th>";
echo "<th><input type='text' class='form-control' placeholder='Email' disabled></th>";
echo "<th><input type='text' class='form-control' placeholder='To' disabled></th>";
echo "<th><input type='text' class='form-control' placeholder='From' disabled></th>";
echo "<th><input type='text' class='form-control' placeholder='LRT' disabled></th>";
echo "<th><input type='text' class='form-control' placeholder='Lane' disabled></th>";
echo "</tr>";
echo "</thead>";
...
?>
      <center><?php echo $this->pagination->create_links(); ?></center>
            <?php echo anchor("login/view_admin","View Users",array("class" => "btn btn-success btn-lg","style" => "margin-left:80%"));?>
            <?php echo '<br>';?>
